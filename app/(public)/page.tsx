...
import { getEvents, getFaqs, getFeaturedNews, getInternships, getScholarships, getSiteSettings } from "@/services/content-service";
    ...
    <>
      <section className="institutional-band border-b">
        <div className="container grid gap-10 py-10 md:grid-cols-[1.05fr_0.95fr] md:items-center md:py-16">
          <FadeIn>
            <Badge variant="secondary" className="mb-4">UTN Facultad Regional Tucumán</Badge>
            <h1 className="text-4xl font-bold tracking-tight text-utn-ink md:text-6xl">
              {siteSettings.institutionName}
            </h1>
            <p className="mt-5 max-w-xl text-lg leading-8 text-muted-foreground">
              Un espacio institucional para informar, orientar y acompañar a estudiantes durante su vida universitaria.
            </p>
          ...
          <FadeIn className="relative min-h-72 overflow-hidden rounded-lg border bg-card shadow-soft md:min-h-[430px]">
            ...
            />
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-utn-ink/78 to-transparent p-5 text-white">
              <p className="text-sm font-semibold">Comunicación clara para estudiantes</p>
              <p className="mt-1 text-sm text-white/85">Noticias, eventos, becas, pasantías y recursos en un solo lugar.</p>
            </div>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="container py-12">
        <div className="mb-6 flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-bold text-utn-ink md:text-3xl">Noticias destacadas</h2>
          </div>
      ...
      <section className="border-y bg-slate-50 py-12">
        <div className="container">
          <div className="mb-6">
            ...
            <h2 className="mt-2 text-2xl font-bold text-utn-ink md:text-3xl">Encontrá lo que necesitás</h2>
          </div>
          <QuickAccess />
        </div>
      </section>
      ...
      <section className="container grid gap-8 py-12 lg:grid-cols-[1fr_0.85fr]">
        <div>
          <div className="mb-6">
            ...
            <h2 className="mt-2 text-2xl font-bold text-utn-ink md:text-3xl">Próximos eventos</h2>
          </div>
            ...
            {upcomingEvents.length > 0 ? (
              ...
              <Card className="shadow-sm">
                <CardContent className="p-5">
                  <h3 className="font-semibold text-utn-ink">Sin eventos próximos</h3>
        ...
        <div>
          <div className="mb-6">
            ...
            <h2 className="mt-2 text-2xl font-bold text-utn-ink md:text-3xl">Becas, pasantías y convocatorias</h2>
          </div>
          <div className="grid gap-4">
            {[...scholarshipItems, ...internshipItems].slice(0, 4).map((item) => {
              ...
              <Card key={`${type}-${item.id}`} className="shadow-sm">
                <CardContent className="p-5">
                  ...
                  <h3 className="mt-3 font-semibold text-utn-ink">{"company" in item ? item.title : item.title}</h3>
      ...
      <section className="border-t bg-slate-50 py-12">
        <div className="container grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-bold text-utn-ink md:text-3xl">FAQ</h2>
            <p className="mt-3 text-muted-foreground">Respuestas rápidas para trámites, becas, pasantías y acompañamiento.</p>
          </div>
